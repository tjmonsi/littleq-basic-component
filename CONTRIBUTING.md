# Contributing to littleq-basic-component
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/littleq-basic-component %>
   # Navigate to the newly cloned directory
   cd littleq-basic-component
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/tjmonsi/littleq-basic-component %>
   ```
